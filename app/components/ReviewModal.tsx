          ...
          <div className="fixed inset-0 z-[201] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="p-7">
                ...
                {/* Full review text */}
                {review.text && (
                  <p className="font-sans text-gray-300 leading-relaxed text-base mb-6">
                ...
                {review.photos && review.photos.length > 0 && (
                  <div
                    className={`grid gap-3 ${review.photos.length === 1 ? 'grid-cols-1' : 'grid-cols-2'}`}
                  >
                    {review.photos.map((src, i) => (
                      <ModalPhoto key={src} src={src} alt={`Photo ${i + 1} from ${review.name}`} />
                    ))}
                  </div>
                )}
              </div>
